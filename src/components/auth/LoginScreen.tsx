...
// Serve static assets from the public/assets folder to avoid requiring image module declarations
import studentsImage from '../../assets/aiuis-login-illustration.png';
import backgroundImage from '../../assets/aiuis-bg.jpg';
interface LoginScreenProps {
  onLogin: (role: 'principal' | 'teacher' | 'admin', username: string, password: string) => boolean;
}
...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  const [currentRole, setCurrentRole] = useState<'principal' | 'teacher' | 'admin'>('teacher');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isLogin) {
      ...
      const success = onLogin(currentRole, username, password);
      if (!success) {
      ...
      <Card className="w-full max-w-5xl relative z-10 shadow-2xl border-blue-800/50 bg-black/98 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
          ...
          />
                  ...
                  <h2 className="text-black mb-4">Welcome to KSIS</h2>
              ...
              <div className="max-w-md mx-auto w-full">
                ...
                <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
                  ...
                  <p className="text-gray-600 text-center mb-8 text-sm">
                    {isLogin ? 'Sign in to continue' : 'Join the KSIS Teacher Performance System'}
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <Button type="submit" className="w-full bg-blue-900 hover:bg-blue-950 text-black shadow-lg">
                    ...
                    <div className="text-center">
                      <p className="text-gray-600 text-sm">
                        ...
                        <button onClick={toggleMode} type="button" className="text-blue-900 hover:underline">
