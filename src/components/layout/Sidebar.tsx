import { Home, FileText, History, BarChart3, Bell, Settings, Users, LogOut, X, Award, Calculator, Clock, RefreshCw, MessageSquare } from 'lucide-react';
...
export function Sidebar({ role, currentView, onNavigate, onLogout, isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-black border-r border-gray-200 transform transition-transform duration-200 ease-in-out ${
  ...
  className={`w-full flex items-center gap-4 px-4 py-3 rounded-lg transition-shadow ${
    isActive
