...
const teachers: Teacher[] = [
  { id: 1, name: 'Dr. Mozaherul Islam', email: 'mozaherul@school.edu', phone: '+60-123-456789', office: 'S101', qualification: 'PhD Computer Science', experience: 12, kpi: 95.8, students: 120, rating: 4.8 },
  { id: 2, name: 'Mdm Nadiah Arsat', email: 'nadiah@school.edu', phone: '+60-123-456790', office: 'M102', qualification: 'Master of Education', experience: 10, kpi: 94.5, students: 100, rating: 4.7 },
  { id: 3, name: 'Mr Zukifli Ahmad', email: 'zukifli@school.edu', phone: '+60-123-456791', office: 'IT103', qualification: 'Bachelor of IT', experience: 8, kpi: 93.2, students: 110, rating: 4.6 },
  { id: 4, name: 'Dr. Umi Safiah', email: 'umi@school.edu', phone: '+60-123-456792', office: 'ML104', qualification: 'PhD Machine Learning', experience: 9, kpi: 92.7, students: 95, rating: 4.5 },
  { id: 5, name: 'Mdm Halawati Hassan', email: 'halawati@school.edu', phone: '+60-123-456793', office: 'SE105', qualification: 'Master of SE', experience: 11, kpi: 91.5, students: 105, rating: 4.4 },
  { id: 6, name: 'Mr Faizal Rahman', email: 'faizal@school.edu', phone: '+60-123-456794', office: 'S106', qualification: 'Bachelor of Science', experience: 7, kpi: 90.2, students: 115, rating: 4.3 },
  { id: 7, name: 'Mdm Siti Nurhaliza', email: 'siti@school.edu', phone: '+60-123-456795', office: 'M107', qualification: 'Master of Education', experience: 6, kpi: 89.8, students: 108, rating: 4.2 },
  { id: 8, name: 'Mr Hamid Hassan', email: 'hamid@school.edu', phone: '+60-123-456796', office: 'IT108', qualification: 'Bachelor of IT', experience: 5, kpi: 88.5, students: 102, rating: 4.1 },
];
                ...
                <Card className="shadow-lg sticky top-6">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="text-center">
                      <p
                        className={`text-sm font-semibold ${selectedTeacher.kpi >= 90
                          ? 'text-green-600'
